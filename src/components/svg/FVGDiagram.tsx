...
export default function FVGDiagram() {
  return (
    ...
    >
      ...
      <text x="120" y="185" fill="#71717a" fontSize="10" textAnchor="middle">candle 1</text>
      <text x="120" y="112" fill="#a1a1aa" fontSize="9" textAnchor="middle">high</text>
      ...
      <text x="190" y="165" fill="#71717a" fontSize="10" textAnchor="middle">candle 2</text>

      {/* Candle 3 */}
      <line x1="260" y1="20" x2="260" y2="90" stroke="#71717a" strokeWidth="1.5" />
      <rect x="248" y="30" width="24" height="35" fill="#10b981" />
      <text x="260" y="105" fill="#71717a" fontSize="10" textAnchor="middle">candle 3</text>
      <text x="260" y="80" fill="#a1a1aa" fontSize="9" textAnchor="middle">low</text>
