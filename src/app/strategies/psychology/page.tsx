  ...
  return (
    ...
    >
      ...
      <Section label="WHY" title="Why the emotional cycle works against you">
        <p>
          Most retail traders unconsciously buy into euphoria (near tops)
          and sell into panic (near bottoms) — the exact opposite of the
          rules-based entries you've already learned.
        </p>
        <EmotionalCycleDiagram />
        <p className="text-sm text-neutral-500">
          A rules-based entry (zone + confirmation candle, pullback + bounce,
          breakout + volume) is specifically designed to pull you out of
          this cycle and into a repeatable process instead.
        </p>
      </Section>
