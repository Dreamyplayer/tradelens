  ...
  return (
    ...
    >
      <Section label="WHAT" title="What counts as support/resistance">
        <p>
          Support and resistance are <strong>zones</strong>, not exact lines.
          A zone is an area where price has previously reversed, stalled, or
          been rejected multiple times — meaning there is a cluster of buy or
          sell orders sitting there. Treating it as a single price point
          causes missed entries and tight stop-outs; treating it as a band
          (zone) gives room for wicks.
        </p>
        <SRZoneDiagram />
        <p className="text-sm text-neutral-500">
          Above: price reacts at the same resistance band three separate
          times before finally breaking through. Support behaves the same
          way in reverse.
        </p>
      </Section>
        ...
        <InfoGrid
          items={[
            ...
            },
            {
              ...
              detail:
                "A level price has respected 2+ times is far more significant than one touched once.",
            },
            {
              title: "Round numbers",
              detail:
                "Psychological levels (e.g. 6,500 / 7,000 in Crude) often act as magnets and reaction points.",
            },
            {
      ...
      <Section label="HOW" title="How to time the entry — confirmation patterns">
        <p>
          Never buy or sell just because price touched a zone — that&apos;s
          guessing. Wait for a candle to actually confirm rejection or
          acceptance at the zone.
        </p>
        <CandlestickPatterns />
        <p>
          A pin bar shows the zone was tested and rejected. An engulfing
          candle shows one side fully overpowered the other. An inside bar
          shows compression right at the zone, often before a sharp move.
        </p>
      </Section>

      <Section label="WHICH" title="Which reaction matters most: role reversal">
        <p>
          When a resistance zone finally breaks with a strong close, it
          frequently flips and becomes support on the retest. This is one of
          the highest-probability entries in price action trading because
          you get confirmation (the break) before you risk capital (the
          retest).
        </p>
        <RoleReversalDiagram />
      </Section>
      ...
      <Section label="WHY" title="Why this works">
        <p>
          Zones represent real resting orders — stop losses, take-profits,
          and fresh institutional entries clustered at the same price area.
          Price reacts there because large orders actually get filled there,
          not because of any indicator. That&apos;s why price action works
          identically on Crude, Nifty, Forex, or Bitcoin — the underlying
          ...
          items={[
            {
              title: "Enter",
              detail:
                "After a confirmation candle closes at the zone, in the direction of the rejection/acceptance.",
            },
            {
              title: "Stop loss",
              detail:
                "Just beyond the outer edge of the zone (past the wick extreme), not right at it.",
            },
          ]}
        />
        <InfoGrid
