  ...
  return (
    ...
    >
      ...
      <Section label="WHY" title="Why this matters more than it seems">
        <p>
          Without a journal, "this strategy isn't working" is usually based
          on the last 3–5 trades, which is not a large enough sample to mean
          anything. A journal turns a vague feeling into an actual number —
          win rate, average R multiple, and whether losses were rule-following
          or rule-breaking.
        </p>
        <EquityCurveDiagram />
        <p className="text-sm text-neutral-500">
          This is what a real edge looks like — a mix of wins and losses
          that still trends upward over enough trades. No strategy in this
          guide wins every time; the curve is what actually proves it works.
        </p>
      </Section>
      ...
      <Section label="WHICH" title="Which to do first: backtest, then journal">
        <p>
          Backtest a strategy over enough historical instances (aim for
          50–100 marked setups) before trading it live with real size. Once
          live, the journal takes over — it's the same data collection,
          just on trades you actually took instead of historical ones.
        </p>
      </Section>
