  ...
  return (
    ...
    >
      <Section label='WHAT' title='What defines a trend'>
        <p>
          A trend is defined by market <strong>structure</strong>: a series of Higher Highs and Higher Lows (uptrend),
          or Lower Highs and Lower Lows (downtrend). A rising or falling moving average (commonly the 20 EMA, or VWAP
          for intraday) is a visual shortcut for the same thing — its slope tells you the trend direction at a glance.
        </p>
      ...
      <Section label='WHERE' title='Where the entry zone is'>
        <p>
          The entry zone is the <strong>pullback</strong> — the shallow dip back toward the moving average or the last
          higher-low, inside an established uptrend (or the equivalent bounce toward a falling average in a downtrend).
          You are not chasing the breakout candle; you are buying the rest.
        </p>
        <MAPullbackDiagram />
      </Section>
      ...
      <Section label='WHICH' title='Which tools to use'>
        <InfoGrid
          items={[
            {
              title: '20 EMA',
              detail: 'Fast-reacting, good for active trend pullbacks on lower timeframes.',
            },
            {
              title: '50 EMA/SMA',
              detail: 'Slower, better for confirming the larger underlying trend.',
            },
            {
              title: 'VWAP',
              detail:
      ...
      <Section label='WHY' title='Why trend following works'>
        <p>
          Markets trend because information and order flow don&apos;t get absorbed instantly — participants build
          positions over time. Once a trend is established, continuation is statistically more likely than an immediate
          reversal, because the same forces that started the move (accumulating buyers or sellers) are usually still
          active. Trading pullbacks instead of tops/bottoms means you&apos;re entering with that existing momentum, not
          against it.
        </p>
      </Section>
